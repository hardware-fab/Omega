...
architecture rtl of tile_acc is
  ...
  constant this_n_cores        : integer      := tile_n_cores(this_tile_id);
  constant this_log2_n_cores   : integer      := tile_log2_n_cores(this_tile_id);
...
-------------------------------------------------------------------------------
  ...
  queue_single_plane: if num_noc_planes = 1 generate
    acc_tile_q_1 : acc_tile_q_1plane
      generic map (
        tech => CFG_FABTECH)
      port map (
        rst                        => rstn_tile,
