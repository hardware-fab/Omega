...
#SYSCLK4
set_property IOSTANDARD LVDS [get_ports clk_board_n]
set_property PACKAGE_PIN F24 [get_ports clk_board_p]
set_property PACKAGE_PIN F23 [get_ports clk_board_n]
set_property IOSTANDARD LVDS [get_ports clk_board_p]
...
create_clock -period 10.000 -name clk_board_p [get_ports clk_board_p]
...
##
##################################################################################################################################################################
set_property PACKAGE_PIN BE45     [get_ports dram_stat_catrip] ;# Bank  65 VCCO - VCC1V8   - IO_L22P_T3U_N6_DBC_AD0P_D04_65
set_property IOSTANDARD  LVCMOS18 [get_ports dram_stat_catrip] ;# Bank  65 VCCO - VCC1V8   - IO_L22P_T3U_N6_DBC_AD0P_D04_65
...
##
##################################################################################################################################################################
set_property PACKAGE_PIN BG45 [get_ports cpu_reset_fpga]
set_property IOSTANDARD LVCMOS18 [get_ports cpu_reset_fpga]
...
##
##################################################################################################################################################################
set_property PACKAGE_PIN BK41 [get_ports uart0_rxd]
set_property IOSTANDARD LVCMOS18 [get_ports uart0_rxd]
set_property PACKAGE_PIN BJ41 [get_ports uart0_txd]
...
set_input_delay -clock [get_clocks clk_board_p] 0.000 [get_ports cpu_reset_fpga]
set_false_path -from [get_ports cpu_reset_fpga] -to [get_pins sync_rst0_reg/D]

set_input_delay -clock [get_clocks clk_board_p] 0.000 [get_ports uart0_rxd]
#set_false_path -from [get_ports uart0_rxd] -to [get_pins {esp_1/tiles_gen[5].io_tile.tile_io_i/tile_io_1/ua1.uart1/r_reg[rxf][0]/D}]
set_false_path -from [get_ports uart0_rxd]

set_output_delay -clock [get_clocks clk_board_p] 0.000 [get_ports uart0_txd]
#set_false_path -from [get_pins {esp_1/tiles_gen[5].io_tile.tile_io_i/tile_io_1/ua1.uart1/r_reg[txd]/C}] -to [get_ports uart0_txd]
set_false_path -to [get_ports uart0_txd]

connect_debug_port dbg_hub/clk [get_nets clk_board]
