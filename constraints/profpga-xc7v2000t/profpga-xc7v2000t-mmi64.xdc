...
# {CLK_P_0}
set_property PACKAGE_PIN AE40 [get_ports clk_board_p]
set_property PACKAGE_PIN AF40 [get_ports clk_board_n]
...
create_clock -period 10.000 [get_ports clk_board_p]

# mmi and the rest of the desing are asynchronous

set_clock_groups -asynchronous -group [get_clocks clk_board_p] -group [get_clocks [get_clocks -of_objects [get_nets clk_board]]]
#set_clock_groups -asynchronous -group [get_clocks profpga_clk0_p] -group [get_clocks [get_clocks -of_objects [get_nets clkm_2]]]  #GM change
#set_clock_groups -asynchronous -group [get_clocks [get_clocks -of_objects [get_nets clkm_2]]] -group [get_clocks *clk_mmi64]      #GM change
#set_clock_groups -asynchronous -group [get_clocks [get_clocks -of_objects [get_nets clkm]]] -group [get_clocks *clk_mmi64]        #GM change
#set_clock_groups -asynchronous -group [get_clocks clk_nobuf] -group [get_clocks *clk_mmi64]                    #GM change
...
set_input_delay -clock clk_board_p 0.000 [get_ports profpga_sync0_p]
