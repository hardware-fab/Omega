...
| specific.
*----------------------------------------------------------------------------*/
#include "softfloat-specialize_hw"
...
static float64
float64_div_int (float64 a, float64 b)
{
...
void float64_div_hw (float64 operands[2],
								float64 result[1])
{

	result[0] = float64_div_int(operands[0], operands[1]);
