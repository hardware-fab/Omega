...
#include <stdio.h>
static
void KeccakF1600_StatePermute(UINT8 *state)
{
...
#define PADDED_INPUT_FILENAME "sha3_padded_input_512_16.dat"
                  ...
                  unsigned long long int outputByteLen)
{
   ...
   //GM change: remove the padding from this function - padding must be already present in the input message
