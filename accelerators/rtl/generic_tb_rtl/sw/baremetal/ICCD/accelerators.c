...
const int32_t sizeof_token[N_ACC_TYPES] = {sizeof(token_adpcm_t), sizeof(token_aes_t), sizeof(token_blowfish_t), sizeof(token_dfadd_t), sizeof(token_dfdiv_t), sizeof(token_dfmul_t), sizeof(token_dfsin_t), sizeof(token_gsm_t), sizeof(token_mips_t), sizeof(token_motion_t), sizeof(token_sha_t),
  sizeof(token_aes256_t), sizeof(token_sha3_t)
};

const int32_t batch_bytes[N_ACC_TYPES] = {8000, 128, 5200, 8, 8, 8, 8, 336, 32, 48, 16384, 16, 1088};
...
{
    printf("Checkpoint5 - Inside config_acc_param (acc_type = %d)\n", acc_type);
	if(acc_type==0)
	{
	...
	{
        printf("Checkpoint6 - Inside SHA register's initialization\n");
        ...
        printf("Checkpoint7 - Ended SHA register's initialization\n");
	}
	else if(acc_type==11)
	{
