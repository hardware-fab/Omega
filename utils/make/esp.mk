...
#GM change: added these lines for the automatic esp configuration
esp-config: $(ESP_CFG_BUILD)/socmap.vhd $(ESP_CFG_BUILD)/.esp_config $(GRLIB_CFG_BUILD)/grlib_config.vhd top.vhd Makefile
	$(QUIET_DIFF)echo "checking .esp_config..."
	@cd $(ESP_CFG_BUILD); \
	/usr/bin/diff .esp_config $(ESP_DEFCONFIG) -q > /dev/null; \
	if test $$? = "0"; then \
