...
#GM change: profpga version

#Original
#PROFPGA_REQUIRED_VER = proFPGA-2019A-SP4

#Superquark
#PROFPGA_REQUIRED_VER = proFPGA-2020D-SP2

#Enterprise/Arizona
PROFPGA_REQUIRED_VER = proFPGA-2019A-SP2
...
TOP_VHDL_RTL_SRCS += $(wildcard $(DESIGN_PATH)/socketgen/dpr/tile_*.vhd)
...
TOP_VLOG_SIM_SRCS += $(DESIGN_PATH)/$(SIMTOP).sv
